...
Small municipal website calendar patterns — single unified view of all time-sensitive items across the organization.

## Status

Deferred. Dashboard is currently hidden behind debug flag. Revisit post-MVP.
