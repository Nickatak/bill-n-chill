...
- [x] Create an CO, send it, open public link, approve/reject once.
- [ ] Create an invoice, send it, open public link, approve/dispute once.
- [ ] If applicable, create a change order and test public approve/reject.
