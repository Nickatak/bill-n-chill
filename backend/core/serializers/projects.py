...
class ProjectFinancialSummarySerializer(serializers.Serializer):
    ...
    active_budget_id = serializers.IntegerField(allow_null=True)
    active_budget_source_estimate_id = serializers.IntegerField(allow_null=True)
    active_budget_source_estimate_version = serializers.IntegerField(allow_null=True)
