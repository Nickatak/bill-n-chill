...
urlpatterns = [
    ...
    path(
        "projects/<int:project_id>/receipts/",
        project_receipts_view,
    ...
    path(
        "public/estimates/<str:public_token>/otp/",
        public_estimate_request_otp_view,
        name="public-estimate-request-otp",
    ),
    path(
        "public/estimates/<str:public_token>/otp/verify/",
        public_estimate_verify_otp_view,
        name="public-estimate-verify-otp",
    ),
    path(
    ...
    path(
        "public/change-orders/<str:public_token>/otp/",
        public_change_order_request_otp_view,
        name="public-change-order-request-otp",
    ),
    path(
        "public/change-orders/<str:public_token>/otp/verify/",
        public_change_order_verify_otp_view,
        name="public-change-order-verify-otp",
    ),
    path(
    ...
    path(
        "public/invoices/<str:public_token>/otp/",
        public_invoice_request_otp_view,
        name="public-invoice-request-otp",
    ),
    path(
        "public/invoices/<str:public_token>/otp/verify/",
        public_invoice_verify_otp_view,
        name="public-invoice-verify-otp",
    ),
    path(
    ...
    path("receipts/scan/", receipt_scan_view, name="receipt-scan"),
    path(
