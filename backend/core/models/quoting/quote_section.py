"""QuoteSection model — named divider within a quote's flat ordering."""
...
class QuoteSection(models.Model):
    ...
    Sections act as visual grouping boundaries within a quote. Each section's
