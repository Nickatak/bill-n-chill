/**
 * Shared test fixtures for the quotes feature test suite.
 */

import type { QuotePolicyContract, QuoteStatusEventRecord } from "../types";

// ---------------------------------------------------------------------------
// Policy contract
// ---------------------------------------------------------------------------

export const policyContract: QuotePolicyContract = {
  policy_version: "1",
...
export const statusEvents: QuoteStatusEventRecord[] = [
  {
    id: 1,
    from_status: null,
    to_status: "draft",
