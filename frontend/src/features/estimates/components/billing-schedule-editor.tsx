 ...
 *
 * Reusable across estimate creator, project overview, and public preview.
 * Periods are project-scoped; dollar amounts are computed from the provided
 * estimateTotal at render time (not stored on the period).
 */
"use client";
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.table}>
        ...
        {periods.map((p) => {
          ...
          const amount = estimateTotal * pct / 100;
