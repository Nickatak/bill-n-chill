...
type UserData = { token?: string; email?: string };

type ProjectRecord = { id: number; name: string; customer_display_name: string };

type CostCode = { id: number; code: string; name: string; is_active: boolean };
...
type EstimateStatusEventRecord = {
  id: number;
